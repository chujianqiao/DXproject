...
public class XinYuan {
    ...
    private String SSOURCECODETYPE;
    private Long NSOURCERATE;
    ...
    public String getSSOURCECODETYPE() {
        return SSOURCECODETYPE;
    }

    public void setSSOURCECODETYPE(String SSOURCECODETYPE) {
        this.SSOURCECODETYPE = SSOURCECODETYPE;
    }

    public Long getNSOURCERATE() {
        return NSOURCERATE;
    }

    public void setNSOURCERATE(Long NSOURCERATE) {
        this.NSOURCERATE = NSOURCERATE;
    }
