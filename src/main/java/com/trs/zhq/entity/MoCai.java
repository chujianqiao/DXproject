...
public class MoCai {
    ...
    private Long NCARRIER_FREQ;
    private Long NIF_FREQ;
    private Long NCARRIER_BAND;
    private Long NDATA_SAMPLERATE;
    private String SFILTER_BAND;
    private String SSAMPLEDATA_TYPE;
    private String SSAMPLEGAIN_TYPE;
    private Long SSAMPLEGAIN;
    private Long NDATA_CARRIERFREQ;
    private String DDATA_RECBTIME;
    private String DDATA_RECETIME;
    private Long NDATA_RECDURATION;
    private Long NSAMPLE_BITS;
    private Long NSAMPLE_VALID_BITS;
    ...
    public Long getNCARRIER_FREQ() {
        return NCARRIER_FREQ;
    }

    public void setNCARRIER_FREQ(Long NCARRIER_FREQ) {
        this.NCARRIER_FREQ = NCARRIER_FREQ;
    }

    public Long getNIF_FREQ() {
        return NIF_FREQ;
    }

    public void setNIF_FREQ(Long NIF_FREQ) {
        this.NIF_FREQ = NIF_FREQ;
    }

    public Long getNCARRIER_BAND() {
        return NCARRIER_BAND;
    }

    public void setNCARRIER_BAND(Long NCARRIER_BAND) {
        this.NCARRIER_BAND = NCARRIER_BAND;
    }

    public Long getNDATA_SAMPLERATE() {
        return NDATA_SAMPLERATE;
    }

    public void setNDATA_SAMPLERATE(Long NDATA_SAMPLERATE) {
        this.NDATA_SAMPLERATE = NDATA_SAMPLERATE;
    }

    public String getSFILTER_BAND() {
        return SFILTER_BAND;
    }

    public void setSFILTER_BAND(String SFILTER_BAND) {
        this.SFILTER_BAND = SFILTER_BAND;
    }

    public String getSSAMPLEDATA_TYPE() {
        return SSAMPLEDATA_TYPE;
    }

    public void setSSAMPLEDATA_TYPE(String SSAMPLEDATA_TYPE) {
        this.SSAMPLEDATA_TYPE = SSAMPLEDATA_TYPE;
    }

    public String getSSAMPLEGAIN_TYPE() {
        return SSAMPLEGAIN_TYPE;
    }

    public void setSSAMPLEGAIN_TYPE(String SSAMPLEGAIN_TYPE) {
        this.SSAMPLEGAIN_TYPE = SSAMPLEGAIN_TYPE;
    }

    public Long getSSAMPLEGAIN() {
        return SSAMPLEGAIN;
    }

    public void setSSAMPLEGAIN(Long SSAMPLEGAIN) {
        this.SSAMPLEGAIN = SSAMPLEGAIN;
    }

    public Long getNDATA_CARRIERFREQ() {
        return NDATA_CARRIERFREQ;
    }

    public void setNDATA_CARRIERFREQ(Long NDATA_CARRIERFREQ) {
        this.NDATA_CARRIERFREQ = NDATA_CARRIERFREQ;
    }
    ...
    public Long getNSAMPLE_BITS() {
        return NSAMPLE_BITS;
    }

    public void setNSAMPLE_BITS(Long NSAMPLE_BITS) {
        this.NSAMPLE_BITS = NSAMPLE_BITS;
    }

    public Long getNSAMPLE_VALID_BITS() {
        return NSAMPLE_VALID_BITS;
    }

    public void setNSAMPLE_VALID_BITS(Long NSAMPLE_VALID_BITS) {
        this.NSAMPLE_VALID_BITS = NSAMPLE_VALID_BITS;
    }
